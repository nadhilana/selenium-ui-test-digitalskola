...
describe("Checkout Test with Screenshot Comparison", function () {
  let driver;
  let checkoutPage;
  let addToCartPage;
  ...
  it("Complete checkout and take screenshot", async function () {
    ...
    fs.writeFileSync(path.join(__dirname, '../Screenshots/checkout-confirmation.png'), screenshot, 'base64');
